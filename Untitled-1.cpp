...
struct tour{
 	char ad_place[20],ad_code[20],ad_country[20],ad_days[20],ad_prices[20],ad_login[20];
...
// ADMIN PANEL
void Tourist::ad_login()
{
    int i=0,j=0,c;
    char uname[10],p[10]="fs",q[10]="1234";
    char pword[10];
    do
    {
        cout<<"\n\n\n\n\n\t~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~"<<endl;
...
void Tourist::us_display(){
    ...
    cout<<"------------------------------------------------------------------------------------------------------------------------\n";
    cout<<"Sl No.\tNAME\t\tCONTACT NO\t\tTOTAL PEOPLE\t\tDATE\t\tDEST. CODE\t\tSTATUS\n";
    cout<<"------------------------------------------------------------------------------------------------------------------------\n";
    int c=1;
    while(1){
        fp.getline(buff,45);
